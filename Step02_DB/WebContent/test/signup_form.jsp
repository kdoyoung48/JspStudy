...
<!-- 
	...
	language 칼럼에는 선택하지 않으면 NULL 을 넣고
	Java 를 선택하면 Java
	Java와 Python 을 선택하면 Java,Phthon
	Java와 Python 과 C++을 선택하면 Java,Phthon,C++
	문자열이 저장되도록 하세요.
...
<form action="signup.jsp" method="post">
	...
	<!-- 
		...
		String[] =request.getParamterValues("language")
	 -->
	배우고 싶은 언어 체크
	<label>
	...
	<br />
	남기고 싶은 말 <!-- textarea 개행과 tab 키를 인식함 -->
	<br />
