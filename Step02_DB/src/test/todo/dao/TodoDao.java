...
/*
 * application 전역에 대해서  Dao 객체는 오직 한번 만 생성되는 구조로 바꾸어야 한다.
 * 
 * 웹 어플리케이션은 여러 Client의 요청을 빠르게 처리 해야 하기 때문에 불필요한  Dao의 
 * 
 * 중복 생성은 웹 어플리케이션의 성능에 영향을 주기 때문이다
 */
public class TodoDao {
	...
	public TodoDto getDate(int num) {
		TodoDto dto=null;
